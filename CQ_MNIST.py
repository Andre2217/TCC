...
def calculate_metrics_and_boxplots(y_true, y_pred):
    ...
    fscore = f1_score(y_true, y_pred, pos_label='1')
...
# Filtrando apenas os dígitos 0 e 1
X_binary = X[(y == '0') | (y == '1')]
y_binary = y[(y == '0') | (y == '1')]
...
for i in range(10):
    ...
    X_train, X_test, y_train, y_test = train_test_split(X_binary, y_binary, test_size=0.2, random_state=i)
