...
from CQK_Polinomial_MNIST import QuadraticClassifier
import time
import statistics
...
if __name__ == "__main__":
    ...
    print("Media das metricas:")
    print(f"Acurácia: {np.mean(acuracias):.5f}")
    print(f"Sensibilidade: {np.mean(sensibilidades):.5f}")
    print(f"Especificidade: {np.mean(especificidades):.5f}")
